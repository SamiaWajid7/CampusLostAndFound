        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_AspNetUsers_ClaimedByUserId",
                        column: x => x.ClaimedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Items_AspNetUsers_ReportedByUserId",
                        column: x => x.ReportedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Items_AspNetUsers_VerifiedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClaimantUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    ProofDescription = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Notifications_Claims_RelatedClaimId",
                        column: x => x.RelatedClaimId,
                        principalTable: "Claims",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Notifications_Items_RelatedItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_ClaimedByUserId",
                table: "Items",
                column: "ClaimedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Items_DateOccurred",
                table: "Items",
                column: "DateOccurred");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_ReportedByUserId",
                table: "Items",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_VerifiedByUserId",
                table: "Items",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_RelatedClaimId",
                table: "Notifications",
                column: "RelatedClaimId");

            migrationBuilder.CreateIndex(
                name: "IX_Notifications_RelatedItemId",
                table: "Notifications",
